...
<!doctype html>
  ...
  <body>
  <div>
    <img src="favicon.ico" alt="GS logo" height="55" width="57" style="float: left; padding-right: 6px;" />
      <h1>GradeStrategizer</h1>
  </div>
  <hr />
<?php
  if($title) {
...
function display_user_courses($course_array) {
...
?>
  <br>
  <form name="courses_table" action="course.php" method="post">
  <table width="300" cellpadding="2" cellspacing="0">
  <?php
  $color = "#cccccc";
  echo "<tr bgcolor=\"".$color."\"><td><strong>Courses</strong></td>";
  if ((is_array($course_array)) && (count($course_array) > 0)) {
    foreach ($course_array as $course)  {
      ...
      echo "<tr bgcolor=\"".$color."\"><td>".htmlspecialchars($course)."</a></td>
            <td><input type = \"submit\" name=\"course\" value=\"GO\"></td>
            </tr>";
    }
  } else {
    echo "<tr><td>No courses on record</td></tr>";
  }
?>
  </table>
</form>
